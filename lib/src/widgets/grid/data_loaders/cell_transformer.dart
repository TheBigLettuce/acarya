...
class CellDataTransformer<T extends Cell, I>
    implements DataTransformer<T, int> {
  final void Function(ControlMessage) _send;
  final T Function(CellDataTransformer<T, I>, T) _transformCell;
  final int Function(CellDataTransformer<T, I>) _count;
  ...
  CellDataTransformer(BackgroundDataLoader<T, int> loader, this._transformCell,
